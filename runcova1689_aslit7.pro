pro runcova1689_aslit7,redo=redo
...
covfrac,[fa],'a1689a_s7',returnave,returnave_si,zspec=4.868,smoothfactor=1.,redo=redo
; returnave=[[velarr],[absarr],[absarr_wivar]]
; returnave_si = [[velarr],[si1260],[si1260_wivar]]

covfrac_si,'a1689a_s7',velarr,fc_mcmc,clmd_mcmc,fc_grid,clmd_grid
; fc_grid = size[4,nstepvel] in peak,first quartile,median, third quartiles

set_plot,'ps'
psname='a1689a_s7_covfrac_all.eps'
