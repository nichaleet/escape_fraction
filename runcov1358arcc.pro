...
if n_Elements(redo) eq 1 then prepspec,dir+['boxspec1d.ms1358.009.arcBC.matched.fits','spec1d.1358J.009.arcC.fits'],'ms1358arcc',zspec=4.925

;covfracnew,'ms1358arcc',returnave,returnave_si,lineuse=[1,1,1,1,0],zspec=4.925
covfrac,'ms1358arcc',returnave,returnave_si,lineuse=[1,1,1,1,0],zspec=4.925,rangevel=[-1000.,600.]

covfrac_si,'ms1358arcc',velarr,fc_mcmc,clmd_mcmc,fc_grid,clmd_grid,lineuse_in=[1,1,1],rangevel=[-1000.,600.]
; fc_grid = size[4,nstepvel] in peak,first quartile,median, third quartiles

stop
set_plot,'ps'
psname='output/ms1358arcc_covfrac_all.eps'
