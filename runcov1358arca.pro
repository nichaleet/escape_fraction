...
if n_Elements(redo) eq 1 then prepspec,dir+['spec1d.1358J.008.arcA.matched.fits','spec1d.1358J.008.arcA.matched.fits'],'ms1358arca',zspec=4.925

;covfracnew,'ms1358arcac',returnave,returnave_si,lineuse=[1,1,1,1,0],zspec=4.925
covfrac,'ms1358arca',returnave,returnave_si,lineuse=[1,1,1,1,0],zspec=4.925,rangevel=[-1000.,600.]

covfrac_si,'ms1358arca',velarr,fc_mcmc,clmd_mcmc,fc_grid,clmd_grid,lineuse_in=[1,1,1],rangevel=[-1000.,600.]
; fc_grid = size[4,nstepvel] in peak,first quartile,median, third quartiles

stop
set_plot,'ps'
psname='output/ms1358arca_covfrac_all.eps'
