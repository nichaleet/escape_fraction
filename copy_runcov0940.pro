...
fa = '/scr2/nichal/deimos/rawdata/2015mar/m0940_long/spec1d.Long1.5.007.serendip4.fits'
fb = '/scr2/nichal/deimos/rawdata/2015mar/m0940_long/spec1d.Long1.5.007.serendip3.fits'
fout = '/scr2/nichal/deimos/reduced_data/spec1d.m0940long.combined.fits'
faout = '/scr2/nichal/workspace3/SPEC1D/spec1d.m0940long.007.serendip4.matched.fits'
fbout = '/scr2/nichal/workspace3/SPEC1D/spec1d.m0940long.007.serendip3.matched.fits'
...
;plot
   ...
   ;spec=[blu.skyspec,red.skyspec]
      ...
      plot,lambda,spec,xrange=[min(lambda),7000],xstyle=1,title=title[f],font=0,ystyle=1,/nodata
...
covfrac,[faout,fbout],'macs0940',returnave,returnave_si,lineuse=[1,1,1,1,1],zspec=4.03,smoothfactor=1.,redo=redo
; returnave=[[velarr],[absarr],[absarr_wivar]]
; returnave_si = [[velarr],[si1260],[si1260_wivar]]
stop
covfrac_si,'macs0940',velarr,fc_mcmc,clmd_mcmc,fc_grid,clmd_grid
; fc_grid = size[4,nstepvel] in peak,first quartile,median, third quartiles

set_plot,'ps'
psname='macs0940_covfrac_all.eps'
