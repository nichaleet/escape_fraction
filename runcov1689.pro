...
if n_Elements(redo) eq 1 then prepspec,dir+['spec1d.a1689.007.obja1.fits','spec1d.a1689.012.obja2.matched.fits'],'a1689',zspec=4.867

covfrac,'a1689',returnave,returnave_si,lineuse=[1,1,1,1,1],zspec=4.867,rangevel=[-1000.,600.]

covfrac_si,'a1689',velarr,fc_mcmc,clmd_mcmc,fc_grid,clmd_grid,lineuse_in=[1,1,1],rangevel=[-1000.,600.]
; fc_grid = size[4,nstepvel] in peak,first quartile,median, third quartiles

set_plot,'ps'
psname='output/a1689_covfrac_all.eps'
