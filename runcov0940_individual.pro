pro runcov0940_individual,redo=redo

dir='/scr2/nichal/workspace3/SPEC1D/'

if n_Elements(redo) eq 1 then prepspec,dir+['spec1d.Long1.5.007.arcB.fits','spec1d.Long1.5.007.arcB.fits'],'macs0940B',zspec=4.03

;model1
covfrac,'macs0940B',returnave,returnave_si,lineuse=[1,1,1,1,1],zspec=4.03,rangevel=[-1000.,500.]

;model2 (full model1)
covfrac_si,'macs0940B',velarr,fc_mcmc,clmd_mcmc,fc_grid,clmd_grid,lineuse_in=[1,1,1],rangevel=[-1000.,500.]
; fc_grid = size[4,nstepvel] in peak,first quartile,median, third quartiles

set_plot,'ps'
psname='output/macs0940B_covfrac_all.eps'
